...
if ($master !='save') {
    ...
    require_once(get_custom_file_if_exists('modules/Campaigns/QueueCampaign.php'));
}
...
if (isset($_REQUEST['show_wizard_summary']) && $_REQUEST['show_wizard_summary']) {
    if ((isset($_REQUEST['sendMarketingEmailTest']) && $_REQUEST['sendMarketingEmailTest']) ||
        (isset($_REQUEST['sendMarketingEmailPreview']) && $_REQUEST['sendMarketingEmailPreview']) ||
        ...
        if (isset($_REQUEST['sendMarketingEmailTest']) && $_REQUEST['sendMarketingEmailTest']) {
            $_POST['mode'] = 'test';
        } elseif (isset($_REQUEST['sendMarketingEmailPreview']) && $_REQUEST['sendMarketingEmailPreview']) {
            $_POST['mode'] = 'preview';
        ...
        include get_custom_file_if_exists('modules/Campaigns/QueueCampaign.php');
        exit;
    }
